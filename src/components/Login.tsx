...
export const Login = () => {
  ...
  return (
    <div 
      className="min-h-[100dvh] flex flex-col items-center justify-center p-4 md:p-8 bg-[var(--bg-main)] transition-colors duration-300 bg-cover bg-center bg-no-repeat relative"
